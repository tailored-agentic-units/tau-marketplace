...
- Load skills: **project-management:project-management**, **github-cli:github-cli**
...
- List projects and phases using the project-management:project-management skill
...
- Assess phase progress using the project-management:project-management skill (item counts per phase)
